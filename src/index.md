...
A lightweight MySQL 8.4 CDC (Change Data Capture) engine extracted from MygramDB. Parses MySQL binlog replication events and provides a streaming API for applications. Supports Node.js (N-API) and Python (ctypes) bindings.
