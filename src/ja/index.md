...
MygramDBから抽出した軽量なMySQL 8.4 CDC (Change Data Capture) エンジン。MySQLのbinlogレプリケーションイベントをパースし、アプリケーション向けのストリーミングAPIを提供します。Node.js (N-API) とPython (ctypes) バインディングに対応。
