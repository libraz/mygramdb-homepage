      ...
      themeConfig: {
        nav: [
          ...
          { text: 'FAQ', link: '/ja/faq' },
          {
            text: 'v1.5.3',
            items: [
              { text: 'リリースノート', link: 'https://github.com/libraz/mygram-db/blob/main/docs/releases/v1.5.3.md' },
  ...
  themeConfig: {
    nav: [
      ...
      { text: 'FAQ', link: '/faq' },
      {
        text: 'v1.5.3',
        items: [
          { text: 'Release Notes', link: 'https://github.com/libraz/mygram-db/blob/main/docs/releases/v1.5.3.md' },
